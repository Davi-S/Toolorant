...
import pages.settings_manager.settingsmanagerpageqwidget as settings_manager_pg
...
class MainWindowQMainWindow(QtWidgets.QMainWindow):
    ...
    def setup_pages(self) -> None:
        ...
        self.page_manager.add_page(settings_manager_pg.SettingsManagerPageQWidget, 'settings_manager_pg')
