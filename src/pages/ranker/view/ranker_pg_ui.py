...
class Ui_ranker_pg(object):
    def setupUi(self, ranker_pg):
        ...
        self.playersi_ranks_frm = QFrame(self.main_frm)
        self.playersi_ranks_frm.setObjectName(u"playersi_ranks_frm")
        self.playersi_ranks_frm.setGeometry(QRect(0, 71, 958, 417))
        sizePolicy = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.playersi_ranks_frm.sizePolicy().hasHeightForWidth())
        self.playersi_ranks_frm.setSizePolicy(sizePolicy)
        self.playersi_ranks_frm.setMinimumSize(QSize(958, 417))
        self.playersi_ranks_frm.setMaximumSize(QSize(958, 417))
        self.playersi_ranks_frm.setFrameShape(QFrame.StyledPanel)
        self.playersi_ranks_frm.setFrameShadow(QFrame.Raised)
        self.player_streams_layout = QGridLayout(self.playersi_ranks_frm)
