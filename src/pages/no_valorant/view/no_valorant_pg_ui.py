...
class Ui_main_menu_pg(object):
    def setupUi(self, main_menu_pg):
        ...
        self.no_valorant_main_frm = QFrame(main_menu_pg)
        self.no_valorant_main_frm.setObjectName(u"no_valorant_main_frm")
        self.no_valorant_main_frm.setGeometry(QRect(61, 61, 958, 488))
        self.no_valorant_main_frm.setStyleSheet(u"")
        self.no_valorant_main_frm.setFrameShape(QFrame.StyledPanel)
        self.no_valorant_main_frm.setFrameShadow(QFrame.Raised)
        self.reload_lbl = QLabel(self.no_valorant_main_frm)
        ...
        self.reload_btn = SecondaryQPushButton(self.no_valorant_main_frm)
