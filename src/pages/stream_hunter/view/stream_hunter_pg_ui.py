...
class Ui_stream_hunter_pg(object):
    def setupUi(self, stream_hunter_pg):
        ...
        self.player_streams_frm.setGeometry(QRect(150, 81, 658, 407))
        ...
        self.player_streams_frm.setMinimumSize(QSize(658, 407))
        self.player_streams_frm.setMaximumSize(QSize(658, 407))
