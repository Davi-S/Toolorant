...
class Ui_main_menu_pg(object):
    def setupUi(self, main_menu_pg):
        ...
        self.settings_manager_btn = BigOptionQPushButton(self.options_frm)
        self.settings_manager_btn.setObjectName(u"settings_manager_btn")
        self.settings_manager_btn.setIcon(icon)
        self.settings_manager_btn.setIconSize(QSize(9, 9))

        self.verticalLayout_2.addWidget(self.settings_manager_btn)
    ...
    def retranslateUi(self, main_menu_pg):
        ...
        self.settings_manager_btn.setText(QCoreApplication.translate("main_menu_pg", u"   SETTINGS MANAGER", None))
