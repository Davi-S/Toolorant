...
class PrimaryCheckBoxQPushButton(CheckBoxQPushButton):
    normal_color = QtGui.QColor(255, 70, 85, 255)
    hover_color = QtGui.QColor(255, 255, 255, 255)
    color_animation_duration = 200

    normal_background = QtGui.QColor(15, 27, 35, 255)
    hover_background = QtGui.QColor(255, 70, 85, 255)
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._text = {True: 'ACTIVATED', False: 'DEACTIVATED'}
    ...
    def mouseReleaseEvent(self, event):
        ...
        self.setText(self._text[self.is_checked])